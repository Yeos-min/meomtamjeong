...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbce] text-[36px] tracking-[-1.8px] w-full">
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[320px] pt-[8px] relative shrink-0 w-[320px]" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#e4beb4] text-[14px] w-[313.61px]">
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-bold h-[20px] justify-center leading-[0] relative shrink-0 text-[#ffb5a0] text-[14px] w-[21.08px]">
...
function Container5() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[30px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbce] text-[24px] w-[96px]">
  ...
  return (
    <div className="bg-[rgba(255,87,34,0.2)] relative rounded-[2px] self-stretch shrink-0" data-name="Overlay">
      <div className="content-stretch flex flex-col h-full items-start px-[8px] py-[2px] relative">
        <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbd1] text-[10px] tracking-[0.5px] w-[68.02px]">
...
function Background() {
  return (
    <div className="bg-[#3b251c] relative rounded-[2px] self-stretch shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col h-full items-start px-[8px] py-[2px] relative">
        <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#e4beb4] text-[10px] tracking-[0.5px] w-[42px]">
...
function Container10() {
  return (
    <div className="h-[53.5px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans_KR',sans-serif] justify-center leading-[0] left-0 not-italic text-[#e4beb4] text-[14px] top-[29.88px] w-[282.82px]">
...
function Container13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-normal h-[15px] justify-center leading-[0] relative shrink-0 text-[#ab8980] text-[10px] tracking-[-0.5px] uppercase w-[74.63px]">
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center leading-[0] relative shrink-0 text-[#ffdbce] text-[12px] w-[82.14px]">
...
function Paragraph() {
  return (
    <div className="content-stretch flex gap-[3.21px] items-end justify-end leading-[0] pb-[2.5px] pt-[5.5px] relative shrink-0 text-right" data-name="Paragraph">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-normal h-[15px] justify-center relative shrink-0 text-[#ab8980] text-[10px] tracking-[-0.5px] uppercase w-[43.03px]">
        <p className="leading-[15px]">Distance</p>
      </div>
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center relative shrink-0 text-[#ffdbce] text-[12px] w-[31.95px]">
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-bold h-[20px] justify-center leading-[0] relative shrink-0 text-[#ffb5a0] text-[14px] w-[21.2px]">
...
function Container18() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[30px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbce] text-[24px] w-[78.02px]">
...
function Overlay1() {
  return (
    <div className="bg-[rgba(255,87,34,0.2)] relative rounded-[2px] self-stretch shrink-0" data-name="Overlay">
      <div className="content-stretch flex flex-col h-full items-start px-[8px] py-[2px] relative">
        <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbd1] text-[10px] tracking-[0.5px] w-[76.02px]">
...
function Background1() {
  return (
    <div className="bg-[#3b251c] relative rounded-[2px] self-stretch shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col h-full items-start px-[8px] py-[2px] relative">
        <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#e4beb4] text-[10px] tracking-[0.5px] w-[44.52px]">
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center leading-[0] relative shrink-0 text-[#ffdbce] text-[12px] w-[70.2px]">
...
function Paragraph1() {
  return (
    <div className="content-stretch flex gap-[3.2px] items-end justify-end leading-[0] pb-[2.5px] pt-[5.5px] relative shrink-0 text-right" data-name="Paragraph">
      ...
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center relative shrink-0 text-[#ffdbce] text-[12px] w-[34.19px]">
...
function Container31() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[30px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbce] text-[24px] w-[72px]">
...
function Overlay2() {
  return (
    <div className="bg-[rgba(255,87,34,0.2)] relative rounded-[2px] self-stretch shrink-0" data-name="Overlay">
      <div className="content-stretch flex flex-col h-full items-start px-[8px] py-[2px] relative">
        <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffdbd1] text-[10px] tracking-[0.5px] w-[65.52px]">
...
function Container36() {
  return (
    <div className="h-[53.5px] overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Noto_Sans_KR',sans-serif] justify-center leading-[0] left-0 not-italic text-[#e4beb4] text-[14px] top-[29.88px] w-[289.17px]">
...
function Container40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center leading-[0] relative shrink-0 text-[#ffdbce] text-[12px] w-[94.09px]">
...
function Paragraph2() {
  return (
    <div className="content-stretch flex gap-[3.2px] items-end justify-end leading-[0] pb-[2.5px] pt-[5.5px] relative shrink-0 text-right" data-name="Paragraph">
      ...
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] font-semibold h-[16px] justify-center relative shrink-0 text-[#ffdbce] text-[12px] w-[31.16px]">
...
function Button() {
  return (
    <div className="bg-[#3b251c] content-stretch flex gap-[8px] items-center pb-[14px] pt-[12px] px-[32px] relative shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Noto_Sans_KR',sans-serif] h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#ffb5a0] text-[14px] text-center tracking-[1.4px] w-[155.41px]">
